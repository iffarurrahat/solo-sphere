...
async function run() {
  try {
    ...
    app.post("/bid", async (req, res) => {
      ...
      const alreadyApplied = await bidsCollections.findOne(query);
      ...
      const updatedBidCount = await jobsCollections.updateOne(
        jobQuery,
        updateDoc
      );
      console.log(updatedBidCount);
    ...
    app.put("/job/:id", verifyToken, async (req, res) => {
      ...
      const result = await jobsCollections.updateOne(query, updateDoc, option);
      res.send(result);
    });
